...
namespace WebBrowser.Data {
    ...
    public partial class HistoryDataSet : global::System.Data.DataSet {
        ...
        public partial class HistoryDataTable : global::System.Data.TypedTableBase<HistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public HistoryRow AddHistoryRow(string URL, string Title_, string Date) {
        ...
        public partial class HistoryRow : global::System.Data.DataRow {
            ...
            public string Title_ {
                get {
                    return ((string)(this[this.tableHistory.Title_Column]));
                }
                set {
                    this[this.tableHistory.Title_Column] = value;
                }
            }
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [History] WHERE (([Id] = @Original_Id) AND ([URL] = @Original_URL) AN" +
                "D ([Title ] = @Original_Title_) AND ([Date] = @Original_Date))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Title_", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Title ", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [History] ([URL], [Title ], [Date]) VALUES (@URL, @Title_, @Date);\r\nS" +
                "ELECT Id, URL, [Title ], Date FROM History WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Title_", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Title ", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [History] SET [URL] = @URL, [Title ] = @Title_, [Date] = @Date WHERE (([Id" +
                "] = @Original_Id) AND ([URL] = @Original_URL) AND ([Title ] = @Original_Title_) " +
                "AND ([Date] = @Original_Date));\r\nSELECT Id, URL, [Title ], Date FROM History WHE" +
                "RE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Title_", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Title ", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Title_", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Title ", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WebBrowser.Data.Properties.Settings.Default.HistoryBookDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_Id, string Original_URL, string Original_Title_, string Original_Date) {
        ...
        public virtual int Insert(string URL, string Title_, string Date) {
            if ((URL == null)) {
        ...
        public virtual int Update(string URL, string Title_, string Date, int Original_Id, string Original_URL, string Original_Title_, string Original_Date, int Id) {
            if ((URL == null)) {
                throw new global::System.ArgumentNullException("URL");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string URL, string Title_, string Date, int Original_Id, string Original_URL, string Original_Title_, string Original_Date) {
            return this.Update(URL, Title_, Date, Original_Id, Original_URL, Original_Title_, Original_Date, Original_Id);
        }
    }
